        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link 
                to="/app" 
                className="bg-indigo-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-all shadow-sm"
              >
                Get Started Free
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link 
                to="/app"
                className="group bg-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-indigo-700 transition-all shadow-lg hover:shadow-xl flex items-center gap-2"
              >
                Start Creating Free
              ...
              <a 
                href="#features"
                className="bg-white text-gray-900 px-8 py-4 rounded-xl text-lg font-semibold border-2 border-gray-200 hover:border-gray-300 transition-all"
              >
                Learn More
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border-2 border-gray-200 rounded-2xl p-8 hover:border-indigo-300 transition-all">
              ...
              <Link 
                to="/app"
                className="block w-full bg-gray-100 text-gray-900 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-all text-center"
              >
                Start Free
              </Link>
            </div>
            ...
            <div className="border-2 border-indigo-600 rounded-2xl p-8 relative shadow-xl bg-gradient-to-b from-indigo-50 to-white">
              ...
              <Link
                to="/app"
                className="block w-full bg-indigo-600 text-white py-3 rounded-xl font-semibold hover:bg-indigo-700 transition-all shadow-lg text-center"
              >
                Start Pro Trial
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><Link to="/app" className="hover:text-gray-900">Create Invoice</Link></li>
              </ul>
            </div>
