...
// Import jsPDF - this is the critical line
...
export default function InvoiceApp() {
  ...
  useEffect(() => {
    ...
    setInvoiceData(prev => ({ ...prev, subtotal, taxAmount, total }));
  ...
  // ============ PDF GENERATION - THIS IS THE KEY FUNCTION ============
  const generatePDF = () => {
    ...
    try {
      ...
      // SAVE THE PDF - This is the critical line
            ...
            <div className="border-2 border-gray-200 rounded-lg p-8 bg-white max-h-[800px] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-8 mb-8">
                <div className="p-4 bg-indigo-50 rounded-lg">
                  ...
                  {invoiceData.businessAddress && <div className="text-sm text-gray-600 mt-1 whitespace-pre-line">{invoiceData.businessAddress}</div>}
                ...
                <div className="p-4 bg-purple-50 rounded-lg">
                  ...
                  {invoiceData.clientAddress && <div className="text-sm text-gray-600 mt-1 whitespace-pre-line">{invoiceData.clientAddress}</div>}
